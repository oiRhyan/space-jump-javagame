...
public class GamePanel extends OSprite {
    ...
    private Astronaut doodle;
    private ArrayList<Platform> platforms;
    private int score;
    private NewGameListener gameListener;
    private AstronautMovingDetector movingAstronautListener = new AstronautMovingDetector();
    ...
    public GamePanel(Dimension size) {
        ...
        this.addKeyListener(this.movingAstronautListener);
    ...
    private void newGame() {
        this.doodle = new Astronaut();
        this.doodle.addAnimationListener(new AstronautAnimatorListenter());
    ...
    public void gameOver() {
        ...
        this.movingAstronautListener.left = false;
        this.movingAstronautListener.right = false;
        this.movingAstronautListener.flush();
        JOptionPane.showMessageDialog(null, "Total de Pontos " + score,
    ...
    private class AstronautAnimatorListenter extends AnimationListener {
        ...
        public void postAction() {
            if (doodle.getY() > getHeight()) {
                ...
                if (doodle.getVelocity().x > Astronaut.MOVING_VECTOR.x) {
                    doodle.turnRight();
                } else if (doodle.getVelocity().x < -Astronaut.MOVING_VECTOR.x) {
                    doodle.turnLeft();
                }
    ...
    private class AstronautMovingDetector extends NoHoldingKeyListener {
